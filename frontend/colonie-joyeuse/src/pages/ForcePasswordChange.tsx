        ...
        <div className="bg-card rounded-xl shadow-elevated p-8 space-y-6">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
            <p className="text-xs text-amber-800">
              ...
              {isParentFlow
                ? 'Le mot de passe que vous aviez reçu était temporaire. Définissez un mot de passe personnel et sécurisé.'
                : 'Le mot de passe administrateur temporaire doit être remplacé avant tout accès à l’espace.'}
            </p>
          </div>
