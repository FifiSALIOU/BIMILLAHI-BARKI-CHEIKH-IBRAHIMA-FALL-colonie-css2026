...
export const MOCK_PARENTS: Parent[] = [
  { matricule: "CSS-2024-001", prenom: "Amadou", nom: "Diallo", service: "Direction Financière", site: "VDN", motDePasse: "parent123", email: "amadou.diallo@css.sn", telephone: "77 123 45 67", premiereConnexion: false },
  { matricule: "CSS-2024-002", prenom: "Fatou", nom: "Sow", service: "Ressources Humaines", site: "VDN", motDePasse: "parent123", email: "fatou.sow@css.sn", telephone: "77 234 56 78", premiereConnexion: true },
  { matricule: "CSS-2024-003", prenom: "Moussa", nom: "Ndiaye", service: "Direction Technique", site: "ZIGUINCHOR", motDePasse: "parent123", email: "moussa.ndiaye@css.sn", telephone: "77 345 67 89", premiereConnexion: true },
  { matricule: "CSS-2024-004", prenom: "Aïssatou", nom: "Ba", service: "Service Juridique", site: "VDN", motDePasse: "parent123", email: "aissatou.ba@css.sn", telephone: "77 456 78 90", premiereConnexion: true },
  { matricule: "CSS-2024-005", prenom: "Ousmane", nom: "Diop", service: "Communication", site: "MBOUR", motDePasse: "parent123", email: "ousmane.diop@css.sn", telephone: "77 567 89 01", premiereConnexion: true },
  { matricule: "CSS-2024-006", prenom: "Ibrahima", nom: "Fall", service: "Direction Générale", site: "VDN", motDePasse: "parent123", email: "ibrahima.fall@css.sn", telephone: "77 678 90 12", premiereConnexion: true },
  { matricule: "CSS-2024-007", prenom: "Aminata", nom: "Diagne", service: "Comptabilité", site: "ZIGUINCHOR", motDePasse: "parent123", email: "aminata.diagne@css.sn", telephone: "77 789 01 23", premiereConnexion: true },
  { matricule: "CSS-2024-008", prenom: "Mamadou", nom: "Sarr", service: "Informatique", site: "VDN", motDePasse: "parent123", email: "mamadou.sarr@css.sn", telephone: "77 890 12 34", premiereConnexion: true },
  { matricule: "CSS-2024-009", prenom: "Ndèye", nom: "Mboup", service: "Audit Interne", site: "MBOUR", motDePasse: "parent123", email: "ndeye.mboup@css.sn", telephone: "77 901 23 45", premiereConnexion: true },
  { matricule: "CSS-2024-010", prenom: "Cheikh", nom: "Gueye", service: "Logistique", site: "ZIGUINCHOR", motDePasse: "parent123", email: "cheikh.gueye@css.sn", telephone: "77 012 34 56", premiereConnexion: true },
  { matricule: "CSS-2024-011", prenom: "Khady", nom: "Thiam", service: "Marketing", site: "VDN", motDePasse: "parent123", email: "khady.thiam@css.sn", telephone: "76 123 45 67", premiereConnexion: true },
  { matricule: "CSS-2024-012", prenom: "Pape", nom: "Sy", service: "Direction Technique", site: "MBOUR", motDePasse: "parent123", email: "pape.sy@css.sn", telephone: "76 234 56 78", premiereConnexion: true },
  { matricule: "CSS-2024-013", prenom: "Coumba", nom: "Kane", service: "Ressources Humaines", site: "VDN", motDePasse: "parent123", email: "coumba.kane@css.sn", telephone: "76 345 67 89", premiereConnexion: true },
  { matricule: "CSS-2024-014", prenom: "Abdou", nom: "Faye", service: "Service Commercial", site: "ZIGUINCHOR", motDePasse: "parent123", email: "abdou.faye@css.sn", telephone: "76 456 78 90", premiereConnexion: true },
  { matricule: "CSS-2024-015", prenom: "Mariama", nom: "Cissé", service: "Direction Financière", site: "MBOUR", motDePasse: "parent123", email: "mariama.cisse@css.sn", telephone: "76 567 89 01", premiereConnexion: true },
];
